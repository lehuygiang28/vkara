export default {
    ...
    'toast.roomLocked': 'Phòng đang khóa',
    'toast.roomLockedJoinDescription':
        'Phòng đang khóa. Nhờ người đang trong phòng mở khóa, hoặc thử lại sau.',
    'toast.notHost': 'Chỉ host',
    'toast.notHostDescription': 'Chỉ host của phòng mới làm được thao tác này',
    'toast.roomClosed': 'Phòng đã bị đóng',
    'toast.roomClosedDescription': 'Chủ phòng đã đóng phòng này',
    'toast.kicked': 'Đã bị mời khỏi phòng',
    'toast.kickedDescription': 'Host đã mời bạn ra khỏi phòng này',
    ...
    'roomSettings.lockRoom': 'Khóa phòng',
    'roomSettings.unlockRoom': 'Mở khóa phòng',
    'roomSettings.roomLocked': 'Đang khóa',
    'roomSettings.roomUnlocked': 'Đang mở',
    'roomSettings.lockHint':
        'Khi khóa, thiết bị mới không vào được. Thiết bị đã từng vào phòng vẫn reconnect bình thường. Ai đang trong phòng cũng có thể mở khóa.',
    'roomSettings.participants': 'Trong phòng',
    'roomSettings.participantsEmpty': 'Chưa có ai khác',
    'roomSettings.participantsCount': '{count} thiết bị · {online} online',
    'roomSettings.yourDisplayName': 'Tên của bạn trên thiết bị này',
    'roomSettings.yourDisplayNameHint': 'Mọi người trong phòng sẽ thấy tên này',
    'roomSettings.yourDisplayNameHintShort': 'Để trống để dùng tên thiết bị tự nhận diện',
    ...
    'roomSettings.participantActions': 'Thao tác thành viên',
    'roomSettings.participantActionsFor': 'Thao tác với {name}',
    'roomSettings.promote': 'Cấp quyền chủ phòng',
    'roomSettings.demote': 'Gỡ host',
    'roomSettings.kick': 'Mời khỏi phòng',
    'roomSettings.promoteNamed': 'Thăng {name} làm host',
    'roomSettings.demoteNamed': 'Gỡ quyền host của {name}',
    'roomSettings.kickNamed': 'Mời {name} khỏi phòng',
    'roomSettings.statusPromoted': '{name} đã là host',
    'roomSettings.statusDemoted': '{name} không còn là host',
    'roomSettings.statusKicked': 'Đã mời {name} khỏi phòng',
    'roomSettings.confirmPromoteTitle': 'Thăng {name} làm host?',
    'roomSettings.confirmPromoteWarning':
        'Họ sẽ khóa phòng, quản lý thành viên và điều khiển phát được.',
    'roomSettings.confirmKickTitle': 'Mời {name} ra?',
    'roomSettings.confirmKickWarning': 'Họ sẽ rời phòng và không vào lại được khi phòng đang khóa.',
    ...
    'karaoke.score': 'Điểm số',
    'karaoke.gradeLabelPerfect': 'Xuất sắc!',
    'karaoke.gradeLabelGreat': 'Tuyệt vời!',
    'karaoke.gradeLabelGood': 'Rất tốt!',
    'karaoke.gradeLabelOk': 'Tốt!',
    'karaoke.gradeLabelTryHarder': 'Cố lên!',
    'karaoke.gradeEmojiPerfect': '🏆',
    'karaoke.gradeEmojiGreat': '🌟',
    'karaoke.gradeEmojiGood': '🎉',
    'karaoke.gradeEmojiOk': '👏',
    'karaoke.gradeEmojiTryHarder': '💪',
    'karaoke.barRhythm': '🎵 Nhịp',
    'karaoke.barPitch': '🎤 Tone',
    'karaoke.barNotes': '🎼 Nốt',
    'karaoke.autoDismiss': 'Tự động đóng sau {sec} giây…',
    'karaoke.scoringContinues': '⏳ Đang chấm bài tiếp theo...',
    'karaoke.statusVoiceDetected': '🎤 Đang nghe giọng hát...',
    'karaoke.statusWaiting': '🎵 Đang chờ giọng hát...',
    'karaoke.statusIdle': 'Nhấn mic để bắt đầu chấm điểm',
    'karaoke.startButton': 'Bắt đầu chấm điểm',
    'karaoke.stopButton': 'Dừng chấm điểm',
    'karaoke.scoreWillShowAuto': 'Điểm sẽ hiển thị tự động khi bài hát kết thúc.',
    'karaoke.roleScorerTitle': 'Người chấm điểm',
    'karaoke.roleNotScorerTitle': 'Chấm điểm karaoke',
    'karaoke.roleNotScorerHint': 'Thiết bị này chưa được chọn làm người chấm điểm. Chỉ nên có 1 thiết bị làm người chấm điểm mỗi lần.',
    'karaoke.roleClaimButton': 'Chọn thiết bị này làm người chấm điểm',
    'karaoke.roleReleaseButton': 'Huỷ vai trò',
    'karaoke.settingsDismissLabel': 'Thời gian hiển thị điểm karaoke',
    'karaoke.settingsDismissHint': 'Popup kết quả tự động đóng sau khoảng thời gian này.',
    'karaoke.settingsDismissUnit': 'giây',
    'karaoke.settingsShowOnPhoneLabel': 'Hiển thị điểm trên điện thoại',
    'karaoke.settingsShowOnPhoneHint': 'Khi có TV trong phòng, mặc định điểm chỉ hiện trên TV. Bật để hiển thị trên cả điện thoại.',
    'karaoke.errorMicPermission': 'Không thể truy cập microphone. Kiểm tra lại quyền mic.',
} as const;
