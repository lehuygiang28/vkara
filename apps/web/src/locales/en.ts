export default {
    ...
    'toast.roomLocked': 'Room is locked',
    'toast.roomLockedJoinDescription':
        'This room is locked. Ask someone already inside to unlock it, or try again later.',
    'toast.notHost': 'Host only',
    'toast.notHostDescription': 'Only the room host can do that',
    'toast.roomClosed': 'Room closed',
    'toast.roomClosedDescription': 'Room has been closed by the host',
    'toast.kicked': 'Removed from room',
    'toast.kickedDescription': 'A host removed you from this room',
    ...
    'roomSettings.lockRoom': 'Lock room',
    'roomSettings.unlockRoom': 'Unlock room',
    'roomSettings.roomLocked': 'Locked',
    'roomSettings.roomUnlocked': 'Open',
    'roomSettings.lockHint':
        'New devices cannot join while locked. Devices already in the room can reconnect. Anyone in the room can unlock.',
    'roomSettings.participants': 'In this room',
    'roomSettings.participantsEmpty': 'No one else is here yet',
    'roomSettings.participantsCount': '{count} devices · {online} online',
    'roomSettings.yourDisplayName': 'Your name on this device',
    'roomSettings.yourDisplayNameHint': 'Shown to everyone in the room',
    'roomSettings.yourDisplayNameHintShort': 'Leave empty to use the detected device name',
    'roomSettings.saveDisplayName': 'Save',
    ...
    'roomSettings.participantActions': 'Participant actions',
    'roomSettings.participantActionsFor': 'Actions for {name}',
    'roomSettings.promote': 'Make host',
    'roomSettings.demote': 'Remove host',
    'roomSettings.kick': 'Remove from room',
    'roomSettings.promoteNamed': 'Make {name} a host',
    'roomSettings.demoteNamed': 'Remove host from {name}',
    'roomSettings.kickNamed': 'Remove {name} from room',
    'roomSettings.statusPromoted': '{name} is now a host',
    'roomSettings.statusDemoted': '{name} is no longer a host',
    'roomSettings.statusKicked': '{name} was removed from the room',
    'roomSettings.confirmPromoteTitle': 'Make {name} a host?',
    'roomSettings.confirmPromoteWarning':
        'They will be able to lock the room, manage participants, and control playback.',
    'roomSettings.confirmKickTitle': 'Remove {name}?',
    'roomSettings.confirmKickWarning':
        'They will leave the room and cannot rejoin while it is locked.',
    ...
    'karaoke.score': 'Score',
    'karaoke.gradeLabelPerfect': 'Outstanding!',
    'karaoke.gradeLabelGreat': 'Amazing!',
    'karaoke.gradeLabelGood': 'Great!',
    'karaoke.gradeLabelOk': 'Good!',
    'karaoke.gradeLabelTryHarder': 'Keep it up!',
    'karaoke.gradeEmojiPerfect': '🏆',
    'karaoke.gradeEmojiGreat': '🌟',
    'karaoke.gradeEmojiGood': '🎉',
    'karaoke.gradeEmojiOk': '👏',
    'karaoke.gradeEmojiTryHarder': '💪',
    'karaoke.barRhythm': '🎵 Rhythm',
    'karaoke.barPitch': '🎤 Pitch',
    'karaoke.barNotes': '🎼 Notes',
    'karaoke.autoDismiss': 'Closing in {sec} seconds…',
    'karaoke.scoringContinues': '⏳ Scoring next song…',
    'karaoke.statusVoiceDetected': '🎤 Listening to your voice…',
    'karaoke.statusWaiting': '🎵 Waiting for your voice…',
    'karaoke.statusIdle': 'Tap the mic to start scoring',
    'karaoke.startButton': 'Start scoring',
    'karaoke.stopButton': 'Stop scoring',
    'karaoke.scoreWillShowAuto': 'Score appears automatically when the song ends.',
    'karaoke.roleScorerTitle': 'Scorer',
    'karaoke.roleNotScorerTitle': 'Karaoke scoring',
    'karaoke.roleNotScorerHint': 'This device is not the designated scorer. Only one device should score at a time.',
    'karaoke.roleClaimButton': 'Use this device as scorer',
    'karaoke.roleReleaseButton': 'Release role',
    'karaoke.settingsDismissLabel': 'Score display duration',
    'karaoke.settingsDismissHint': 'The result popup closes automatically after this time.',
    'karaoke.settingsDismissUnit': 'sec',
    'karaoke.settingsShowOnPhoneLabel': 'Show score on phone',
    'karaoke.settingsShowOnPhoneHint': 'When a TV is in the room, the score is shown on the TV only by default. Enable to also show it on this phone.',
    'karaoke.errorMicPermission': 'Cannot access microphone. Please check mic permissions.',
} as const;
