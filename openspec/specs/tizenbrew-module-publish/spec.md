# tizenbrew-module-publish Specification

## Purpose
TizenBrew app-module packaging and release of `@vkara/tv` from the shared staged shell, independent of hosted `/tv` web deploys.
## Requirements
