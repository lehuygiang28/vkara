# tv-responsive-layout Specification

## Purpose
Viewport-relative density and height-budget rules for the dedicated `/tv` UI so lobby, idle QR, player chrome, queue, settings, and Next Up remain usable from ~960×540 CSS through 1080p/4K without oversized chrome on short TVs.
