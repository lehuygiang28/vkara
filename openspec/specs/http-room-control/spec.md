# http-room-control Specification

## Purpose

HTTP session and mutation surface for headless agents: join with password or joinToken, then queue/play/next without a WebSocket client.
